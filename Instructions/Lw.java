...
public class Lw {
    ...
    public Lw(ArrayList<LocalRegisters> registersList, ArrayList<Memory> memory, String r1, String r2, String immediate) {
    ...
    public ReturnData performOperation() {
        ...
        if (register_1 != null && register_2 != null) {
            ...
            register_1.setValor(memory.get(register_2.getValue() + immediate).getValue());
        }
